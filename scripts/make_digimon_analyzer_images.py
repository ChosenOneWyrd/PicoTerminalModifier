#!/usr/bin/env python3
"""
make_digimon_analyzer_images.py

Run:
    python make_digimon_analyzer_images.py "Imperialdramon Paladin Mode" --template Digimon_analyzer_blank.jpg --debug
    # For taking profile data from sd/profile folder instead of Wikimon, use:
    python make_digimon_analyzer_images.py "Imperialdramon Paladin Mode" --template Digimon_analyzer_blank.jpg --debug --data-source terminal
    To try all at once: python make_digimon_analyzer_images.py --all-digi-api --debug
    or:                 python make_digimon_analyzer_images.py --all-profile-bin --debug
"""
...
ANIME_IMAGE_KEYWORD_RULES = [
    ...
    ("contains", "Gaiomon_XW24"),
    ("contains", "Gigasmon_DF"),
    ("contains", "Ginkakumon_Ghost_Game_2"),
    ("contains", "Gracenovamon2"),
    ("contains", "Grottemon_DF2"),
    ("contains", "Growmon_angry"),
    ("contains", "Guilmon_DT"),
    ("contains", "GG41_Flawizarmon_lynxmon"),
    ("contains", "Darkdramon_Gigastick_Lance"),
    ("contains", "Dark_Knightmon_Anime_2020"),
    ("contains", "Deadlytsuwamon"),
    ("contains", "Yujo_no_Kizuna-_with_Yamato_LastEvoKizuna"),
    ("contains", "Digimon_frontier_-_episode_01_14"),
    ("contains", "Ebemon_anime"),
    ("contains", "Elephamon_Ghost_Game_2"),
    ("contains", "Garummon_frontier"),
    ("contains", "Goatmon_DF34"),
    ("contains", "Grandlocomon_TRDE"),
    ("contains", "XW_Greymon"),
    ("contains", "Groundramon_Adv2020"),
    ("contains", "HippoGriffomon_Anime"),
    ("contains", "DT51_Hopmon"),
    ("contains", "Hououmon_and_Sora"),
    ("contains", "Huckmon_tri"),
    ("contains", "Hudiemon_hm"),
    ("contains", "DS23_Insekimon"),
    ("contains", "Jellymon_Ghost_Game_2"),
    ("contains", "Jetsilphymon_new_century"),
    ("contains", "Kaiserleomon_Frontier"),
    ("contains", "DS18_Kamemon"),
    ("contains", "Lowemon_Frontier"),
    ("contains", "Leviamon_digimemory_hologram2"),
    ("contains", "Lilamon_DS17"),
    ("contains", "DF_Lucemon_Satan_Mode_4"),
    ("contains", "Machmon_adv2020"),
    ("contains", "Magnagarurumon_DF"),
    ("contains", "DB12_Marinbullmon_2"),
    ("contains", "Merukimon_Savers_3"),
    ("contains", "MetalEtemonDA"),
    ("contains", "MetalgreymonAM_Adv2020-21"),
    ("contains", "MetalGreymonX_DMO"),
    ("contains", "Millenniumon_2020_anime"),
    ("contains", "Minomon_Chibimon"),
    ("contains", "DB16_Moosemon"),
    ("contains", "Neo_Devimon_anime"),
    ("contains", "Neptunemon_XW04"),
    ("contains", "DA2020_Ofanimon1"),
    ("contains", "Omegamon_Zwart_collectors"),
    ("contains", "GG18_Orcamon_and_Kazuma"),
    ("contains", "Ikuto_Peckmon"),
    ("contains", "Yatagaramon_2006"),
    ("contains", "DS_Ravmon"),
    ("contains", "DF14_Petaldramon"),
    ("contains", "Petitmon_DB07"),
    ("contains", "DF18_Pidmon"),
    ("contains", "Digimon_Adventure_Beyond_-_Ken_Pucchiemon"),
...
SKIP_IMAGE_KEYWORDS = {"card", "DM0", "battle", "PSP", "psp", "shikishi", "fantasy", "Examon_2", 
                       ...
                       "Vortex-Spear", "Bx-", "Da-347", "Da-542", "Sx-", "Dcg-", "Bo-3", "DCG_D", "Enmamon_Shambala", "Goldvdramon_D1_Tamers", "Da-515",
                       "Digimon_Adventure_Beyond_-_Marine_Armor_Evolutions", 
                       "DA-61_Dokunemon_scumon_shamamon_numemon_tuchidarumon_delumon_dracomon", "Digimon_Adventure_Beyond_-_Daisuke_Lighdramon",
                       "Da-504", "Digimon_World_ReDigitize_Decode_-_GomamonX", "Bx-60", "Da-525", "Jap.png", "Digimon_World_ReDigitize_Decode_-_Greymon_X",
                       "Sx-8", "Model_Next_Order", "DM-1", "Da-5", "Digimon_Adventure_Beyond_-_Flying_Armor_Digimon", "Justimonx_new_century",
                       "Early_design", "KaiserGreymon_MagnaGarurumon_DF42", "Kaisergreymon_new_century", "Kaisergreymon_crusader",
                       "Kaiser_greymon_crusader", "Chronicle_chap", "Da-2", "Dch-", "Da-1", "Da-0", "ST-1", "Digimon_Seekers_Nightmare_1_-_Injured_Digimon",
...
TEMPLATE_PATH = BASE_DIR / "Digimon_analyzer_blank.jpg"
...
def resolve_analyzer_search_name(raw_name: str) -> str:
    ...
    normalized_fixes = {
        digi_api_name_key(k): v
        for k, v in MANUAL_NAME_FIXES.items()
    }

    if manual_key in normalized_fixes:
        return normalized_fixes[manual_key]
